...
EOF
    ...
    echo ""
    echo "NEXT STEPS:"
    echo "1. Copy the Pi Public Key to your VPS"
    echo "2. On your VPS, edit /etc/wireguard/${WG_INTERFACE}.conf and replace PI_PUBLIC_KEY_PLACEHOLDER with this Pi Public Key"
    echo "3. Restart WireGuard on VPS: systemctl restart wg-quick@$WG_INTERFACE"
    echo ""
